...
public class MainActivity extends AppCompatActivity {
    ...
    private void setInfoDateTime() {
        ...
        for I := 0 to 9 do numbers[i]:=0;


        temp:='';
        d1:=0;d2:=0;m1:=0;m2:=0;y1:=0;y2:=0;y3:=0;y4:=0;
        x1:=0;x2:=0;x3:=0;x4:=0;
        d:=0;m:=0;y:=0;
        z1:=0;z2:=0;z3:=0;z4:=0;
        ...
        for i:=1 to length(temp) do
            begin
        case i of
        1: d1:= strtointdef(temp[i],0);
        2: d2:= strtointdef(temp[i],0);
    else d1:= strtointdef(temp[i],0);
        end;
        end;
...
//if Lang1.Lang = 'RU' then
    ...
    public void setDate(View v) {
        new DatePickerDialog(MainActivity.this, d, myYear, myMonth, myDay).show();
    }
